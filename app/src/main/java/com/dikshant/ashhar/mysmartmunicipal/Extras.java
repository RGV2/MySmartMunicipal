...
public class Extras extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            ...
            editor.remove("key");
            editor.apply();
            Intent intentMain = new Intent(Extras.this, Starter.class);
