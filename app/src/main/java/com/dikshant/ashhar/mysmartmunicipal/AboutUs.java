...
public class AboutUs extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            ...
            editor.remove("key");
            editor.apply();
            Intent intentMain = new Intent(AboutUs.this, Starter.class);
